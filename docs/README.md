...
| `PRODUCT.md` | Stable product outcome, workflow, architecture, and design invariants |
| `ACTIVE_BUILD.md` | Current phase, next slice, non-goals, and acceptance gate |
...
- `../reports/` and `archive/` — historical evidence and superseded planning; never startup context.
...
- Historical gate evidence is written once under `reports/`.
