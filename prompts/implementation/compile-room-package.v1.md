...
Every placement, dimension, and clearance statement must carry exactly one provenance label: owner_measured, photo_observed, model_inferred, manufacturer_specified, or unknown. Any unknown dimension or fit question must link to a concrete open field-verification task. Never convert visual inference into measurement. Typed owner dimensions outrank the image.
